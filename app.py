...
# HTML+JS for floating hearts on button click. It will run on each Streamlit rerun when trigger changes.
...
# Embed the HTML. It will run in an isolated iframe and produce the floating hearts each time 'trigger' changes.
